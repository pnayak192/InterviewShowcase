...
public class ApiPreRequests extends ApiSpecBuilder {
    ...
    public static Response postWithPayload(String endPoint, String payLoad) {
        return given(getRequestSpec()).
                when().
                body(payLoad).
                post(endPoint).
    ...
    public static Boolean validateResponseSchema(String fileName, Response response) {
        ...
        String path = System.getProperty("user.dir") + File.separator + "src/test/resources/schemaFiles" + File.separator;
        try {
